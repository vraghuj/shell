...
var_sql=sqld_9                # Variable holding sql dockerfile name.
var_spr=springd_9               # Variable holding spring-boot dockerfile name
sql_name=sql_contd_9          # Variable holding the sql container name.
container_name=spring_contd_9     # variable holding spring-boot container name
