...
var_sql=sql-446                # Variable holding sql dockerfile name.
var_spr=spr-446                # Variable holding spring-boot dockerfile name
sql_name=sqldb-446             # Variable holding the sql container name.
